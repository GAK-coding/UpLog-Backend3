...
public class PostLikeController {
    ...
    @PostMapping(value = "/members/{member-id}/posts/{post-id}")
...
//    @GetMapping(value = "posts/{post-id}")
//    public ResponseEntity<Integer> test(@PathVariable(name = "post-id")Long postId){
//        int n = likeSerivce.test(postId);
