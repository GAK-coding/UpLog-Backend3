...
public class ProjectTeamService {
    ...
    public Long createProjectTeam(Long projectId, CreateProjectTeamRequest createProjectTeamRequest) throws Exception {
        ...
        for(Long m : createProjectTeamRequest.getMemberIdList()){
            //여기서 조회하는게 최선. memberTeam에서는 프로덕트의 아이디를 알 수 없음. 단방향이라서.
            MemberTeam memberTeam = memberTeamRepository.findMemberTeamByMemberAndTeamId(m, project.getProduct().getId()).orElseThrow(NotFoundIdException::new);
